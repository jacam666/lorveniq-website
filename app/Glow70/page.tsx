...
export default function Glow70Page() {
	...
	const highlights = [
		{
			title: 'Complex Protocol Potential',
			description: 'Suitable for exploratory studies where multi-factor peptide performance is evaluated in depth.',
		},
		{
			title: 'Laboratory Reliability',
			description: 'Produced with consistency standards intended to support repeatable and disciplined experimentation.',
		},
		{
			title: 'Research Compliance Focus',
			description: 'Distributed exclusively for scientific review and controlled institutional laboratory use.',
		},
	];
		...
		<div className="min-h-screen bg-gray-50">
					...
					<div className="relative z-10 grid grid-cols-1 items-center gap-8 md:grid-cols-2">
						<div>
							...
							<p className="mt-4 max-w-xl text-sm leading-relaxed text-slate-600 sm:text-base">
								A precision-formulated compound curated for advanced research programs and structured laboratory protocols.
							</p>
								...
								<button
									...
									onClick={() => {
										addCartItem({
											id: '3',
											name: 'Glow 70MG',
											image: '/images/GLOW_70mg-removebg-preview.png',
											price,
											link: '/Glow70',
										});
										setAdded(true);
			...
			<section className="mx-auto max-w-7xl px-6 pb-16">
				<div className="mb-8 text-center">
					...
					<h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Why Researchers Choose Glow</h2>
				</div>
