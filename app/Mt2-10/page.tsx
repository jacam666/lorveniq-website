	...
	const highlights = [
		{
			...
			description: 'Explored in controlled protocols related to melanocortin pathway activation and response mapping.',
		},
		{
			title: 'Consistent Handling Profile',
			description: 'Prepared to support repeatable laboratory workflows where consistency across studies is critical.',
		},
		{
			title: 'Protocol-Oriented Use',
			description: 'Structured for scientific evaluation by qualified teams operating in controlled research environments.',
		},
	];
		...
		<div className="min-h-screen bg-gray-50">
				...
				<div className="relative mb-10 overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-r from-cyan-50 via-white to-slate-100 p-8 shadow-sm sm:p-10">
					...
					<div className="relative z-10 grid grid-cols-1 items-center gap-8 md:grid-cols-2">
						...
						<div className="group relative h-72 overflow-hidden rounded-2xl border border-cyan-100/90 bg-gradient-to-b from-cyan-50 via-white to-slate-100 sm:h-80">
							<Image
								src="/images/mt2_10mg-removebg-preview.png"
								alt="MT2 10MG"
								fill
			...
			<section className="mx-auto max-w-7xl px-6 pb-16">
				<div className="mb-8 text-center">
					...
					<h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Why Researchers Choose MT2</h2>
				</div>
